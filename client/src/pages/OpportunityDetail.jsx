        ...
        <div className="bg-white dark:bg-[#111622] p-8 md:p-10 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm dark:shadow-xl">
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8">
            <div>
              <div className="flex flex-wrap gap-2 mb-4">
                {opportunity.tags && opportunity.tags.map((tag, idx) => (
                  <span
                    key={idx}
                    className="px-3 py-1 rounded-md bg-sky-50 dark:bg-sky-950/40 text-sky-600 dark:text-sky-400 text-xs font-medium border border-sky-200 dark:border-sky-800/50"
                  >
                    {tag}
                  </span>
                ))}
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-sm transition-colors shadow-lg shadow-sky-600/20 whitespace-nowrap"
            >
              <Mail size={18} /> Apply Now
            </a>
          </div>

          <div className="flex flex-wrap gap-x-10 gap-y-6 mb-10 border-y border-slate-200 dark:border-slate-800 py-6">
