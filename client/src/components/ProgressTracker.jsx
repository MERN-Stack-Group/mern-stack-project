        ...
        {steps.map((step, index) => {
          ...
          return (
            ...
            >
                ...
                <div
                  className={`w-8 h-8 rounded-full flex items-center justify-center text-xs font-bold border-2 transition-colors duration-300 z-10 ${
                    isCompleted || isActive
                      ...
                      : "border-slate-400 dark:border-slate-800 bg-slate-200 dark:bg-[#161d2b] text-slate-400 dark:text-slate-500"
              ...
              {/* Connecting Line */}
              {!isLast && (
                <div className="flex-1 h-1 mx-2 bg-slate-400 dark:bg-slate-800 rounded">
                  <div
